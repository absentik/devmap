...
- [**Каждый уважающий себя разработчик должен знать:**](#Каждый-уважающий-себя-разработчик-должен-знать-)
    ...
    - [x] [Linux, командная строка Bash](#linux-командная-строка-bash-)
    ...
    - [x] [Подходы к разработке](#Подходы-к-разработке-)
...
- [**Карта развития Back-end разработчика:**](#Карта-развития-back-end-разработчика-)
    ...
    - [x] [Фреймворки](#Фреймворки-)
    - [x] [Пакетный менеджер](#Пакетный-менеджер-)
...
### Подходы к разработке [&uarr;](#Содержание)
- [ ] Виды:
    - [ ] TDD
    - [ ] BDD
    - [ ] DDD
